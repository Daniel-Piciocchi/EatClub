...
export const DineInIcon = ({ className = '' }: { className?: string }) => (
    <svg
        className={className}
        width="16"
        height="16"
...
export const LightningIcon = ({ className = '' }: { className?: string }) => (
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path d="M8.5 0L2 8h4.5L5 14l6.5-8H7l1.5-6z" fill="currentColor" />
    </svg>
)

export const CuisineIcon = ({ className = '' }: { className?: string }) => (
    <svg
        className={className}
        width="16"
        height="16"
